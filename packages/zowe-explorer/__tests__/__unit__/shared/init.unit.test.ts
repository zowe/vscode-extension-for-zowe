    ...
    describe("registerCommonCommands", () => {
        ...
        const commands: IJestIt[] = [
            ...
            },
            {
                ...
                mock: [
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.LOGS_FOLDER_PATH], ret: true },
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.TEMP_FOLDER_PATH], ret: false },
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.AUTOMATIC_PROFILE_VALIDATION], ret: false },
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.TEMP_FOLDER_HIDE], ret: false },
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.SECURE_CREDENTIALS_ENABLED], ret: false },
                ],
            },
            {
                name: "onDidChangeConfiguration:2",
                mock: [
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.LOGS_FOLDER_PATH], ret: false },
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.TEMP_FOLDER_PATH], ret: true },
            ...
            },
            {
                ...
                mock: [
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.LOGS_FOLDER_PATH], ret: false },
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.TEMP_FOLDER_PATH], ret: false },
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.AUTOMATIC_PROFILE_VALIDATION], ret: true },
            ...
            },
            {
                ...
                mock: [
                    ...
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.TEMP_FOLDER_PATH], ret: false },
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.AUTOMATIC_PROFILE_VALIDATION], ret: false },
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.TEMP_FOLDER_HIDE], ret: true },
            ...
            },
            {
                ...
                mock: [
                    ...
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.AUTOMATIC_PROFILE_VALIDATION], ret: false },
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.TEMP_FOLDER_HIDE], ret: false },
                    { spy: jest.spyOn(test.value, "affectsConfiguration"), arg: [Constants.Settings.SECURE_CREDENTIALS_ENABLED], ret: true },
